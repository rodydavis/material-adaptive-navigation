 ...
 */var K;((K=window.HTMLSlotElement)===null||K===void 0?void 0:K.prototype.assignedElements)!=null;var It=Object.defineProperty,jt=Object.getOwnPropertyDescriptor,G=(s,t,e,i)=>{for(var n=i>1?void 0:i?jt(t,e):t,r=s.length-1,o;r>=0;r--)(o=s[r])&&(n=(i?o(t,e,n):o(n))||n);return i&&n&&It(t,e,n),n};const Vt="adaptive-scaffold";let U=class extends x{constructor(){super(...arguments),this.breakpoint=0,this.tabs=!1}render(){return p` ${this.getStyles()} ${this.renderNavigation()}`}renderNavigation(){const s=this.getNavigation(),t=this.getNavItems();switch(s){case f.Tabs:return p`
    ...
    `}getStyles(){return p`
      ...
      />
    `}firstUpdated(){window.addEventListener("resize",this.onResize.bind(this)),this.onResize()}onResize(){const s=this.getBreakpoint();s!==this.breakpoint&&(this.breakpoint=s)}getBreakpoint(){const s=window.innerWidth;return s<640?g.Small:s<1024?g.Medium:g.Large}getNavigation(){const s=this.getNavItems().length;if(this.tabs)return f.Tabs;if(s>=2&&s<=5)switch(this.breakpoint){case g.Small:return f.BottomNavigation;case g.Medium:return f.NavigationRail;case g.Large:return f.DrawerPinned}return f.DrawerHidden}getNavItems(){var e,i,n,r,o;const s=[],t=this.querySelector("nav");for(const c of Array.from(t.children)){const l=(i=(e=c.querySelector("label").textContent)!=null?e:c.textContent)!=null?i:"",a=(n=c.getAttribute("href"))!=null?n:"",v=(o=(r=c.querySelector("i"))==null?void 0:r.textContent)!=null?o:"";s.push({href:a,label:l,icon:v})}return s}};U.styles=St`
    :host {
  ...
  `;G([Bt()],U.prototype,"breakpoint",2);G([ft({type:Boolean})],U.prototype,"tabs",2);U=G([Dt(Vt)],U);var g=(s=>(s[s.Small=0]="Small",s[s.Medium=1]="Medium",s[s.Large=2]="Large",s))(g||{}),f=(s=>(s[s.DrawerPinned=0]="DrawerPinned",s[s.DrawerHidden=1]="DrawerHidden",s[s.BottomNavigation=2]="BottomNavigation",s[s.NavigationRail=3]="NavigationRail",s[s.Tabs=4]="Tabs",s))(f||{});
